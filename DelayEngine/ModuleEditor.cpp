...
void ModuleEditor::setLeftMenu()
{
    if (enableWindows) {
        ...
        {
            ImGui::Text("Geometry:"); ImGui::NextColumn();
            // Column header
            ImGui::Columns(2, NULL, false);
            int vertexMesh = App->model->getVertexMeshes();
            ImGui::DragInt("", &vertexMesh, 0.0f); ImGui::NextColumn();
            ImGui::Text("Vertexs"); ImGui::NextColumn();
            int indexsMesh = App->model->getIndexesMeshes();
            ImGui::DragInt("", &indexsMesh, 0.0f); ImGui::NextColumn();
            ImGui::Text("Indexes"); ImGui::NextColumn();
            int facesMesh = App->model->getFacesMeshes();
            ImGui::DragInt("", &facesMesh, 0.0f); ImGui::NextColumn();
